...
### `public/district-stats.json`
- Entries: 435
- Fields per entry: `age` (median), `education` (% college educated), `poverty` (% below poverty line), `population`
- **Data quality: MODEL-ESTIMATED, NOT REAL CENSUS DATA**
- Generated by `scripts/generate-district-stats.mjs` using income+PVI correlations
- Real Census ACS data cannot be fetched in the build environment (HTTP 403 from api.census.gov)
